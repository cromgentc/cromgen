...
import { notifications } from '../../data/enterpriseAdmin.js'
      ...
      {open ? (
        ...
        >
          ...
          <div className="mt-6 rounded-3xl border border-cyan-300/20 bg-cyan-300/10 p-5">
            ...
            <h3 className="mt-4 font-black">AI priority summary</h3>
            <p className="mt-2 text-sm leading-6 text-slate-300">3 operational events need attention before the next payout and QC cycle closes.</p>
          </div>
        </motion.aside>
      ) : null}
    </AnimatePresence>
