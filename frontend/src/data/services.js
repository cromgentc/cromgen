...
export const services = [
  ...
  },
  {
    slug: 'film-industry',
    title: 'Film Industry',
    navTitle: 'Film Industry',
    shortTitle: 'Film',
    kicker: 'Production, post-production, casting, marketing, and digital operations support for film and media teams.',
    accent: '#1f2937',
    warm: '#ff4b2d',
    icon: 'paint',
    image: 'film',
    metrics: [
      ['12+', 'Film service areas'],
      ['360', 'Production support'],
      ['Digital', 'Release growth'],
    ],
    services: [
      ...
      'Portfolio and Showreel Creation',
    ],
    process: ['Creative brief', 'Production planning', 'Execution coordination', 'Release and promotion'],
  },
]
