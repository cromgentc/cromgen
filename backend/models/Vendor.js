...
export async function createVendor(payload) {
  ...
  const vendor = {
    ...
    serviceSubCategory: payload.serviceSubCategory ? String(payload.serviceSubCategory).trim() : '',
    sourcingType: payload.sourcingType ? String(payload.sourcingType).trim() : '',
    sourcingRegion: payload.sourcingRegion ? String(payload.sourcingRegion).trim() : '',
    sourcingLanguage: payload.sourcingLanguage ? String(payload.sourcingLanguage).trim() : '',
